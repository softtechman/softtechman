<div align="center">
      ...
      <g transform="translate(427, 100) scale(1, 1) translate(-427, -100)">
        ...
        <path d="" fill="#0077B5" opacity="0.4" >
         ...
         <text text-anchor="middle" alignment-baseline="middle" x="50%" y="35%" class="text" style="fill:#ffffff;" stroke="#none" stroke-width="1" >Squilliam</text>
        <text text-anchor="middle" alignment-baseline="middle" x="56%" y="52%" class="desc" style="fill:#ffffff;">Web3 Developer</text>
      </svg>
